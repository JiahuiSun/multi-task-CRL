...
def main(args):
    ...
    penalty = nn.Parameter(penalty_init*th.ones(len(task_sche.task_list), dtype=th.float32).to(args.device))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--episode_per_proc', type=int, default=30)
